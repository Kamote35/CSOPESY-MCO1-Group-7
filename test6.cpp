...
void handleSchedulerStart() {
    ...
    thread([]() {
        ...
        // Convert batch frequency (CPU cycles) into a sleep in milliseconds for simulation.
        // We'll interpret 1 CPU-cycle -> 100 ms simulation time (adjustment for visibility).
        // If you want a different mapping, change the multiplier below.
